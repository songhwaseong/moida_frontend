        ...
        {step === 1 ? (
          <>
            ...
            <div className={styles.inputGroup}>
              ...
              {emailChecked === null && errors.email && <p className={styles.fieldError}>{errors.email}</p>}
            </div>
